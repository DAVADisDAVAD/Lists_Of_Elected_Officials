...
# Drop old Congress_Members
c.execute("DROP TABLE Congress_Members")

c.execute("""CREATE TABLE Congress_Members (
           Name text,
           Party text,
           District text,
           Link text
...
# Create list of congress members from string results
results = str(results)
...
for response in prelist:
    ...
    c.execute("INSERT INTO Congress_Members VALUES(?, ?, ?, ?)", (Name, Party, District, link))
...
#Test
root = Tk()
root.title('List of Congress Members')
